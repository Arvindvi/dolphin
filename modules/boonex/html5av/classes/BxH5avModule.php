        ...
        switch($aFile['Status']) {
            ...
            case STATUS_APPROVED:
                if (file_exists($sFilesPath . $iFileId . M4V_EXTENSION)) {
                    ...
                    $sOverride = '
                        <video controls preload="auto" autobuffer style="width:100%; height:' . getSettingValue('video', 'player_height') . 'px;" id="' . $sId . '">
                            ' . $sSourceWebm . '
        ...
        switch($aFile['Status']) {
            ...
            case STATUS_APPROVED:
                if (file_exists($GLOBALS['sFilesPathMp3'] . $iFileId . MP3_EXTENSION)) {
                    ...
                    $sOverride = '
                        <audio controls preload="auto" autobuffer style="width:100%" id="' . $sId . '">
