...
('sys_tmp_version', '7.1.1', @iCatHidden, 'Dolphin version ', 'digit', '', '', 10, ''),
...
INSERT INTO `sys_profile_fields` VALUES(2, 'NickName', 'text', NULL, '', 4, 16, '', 'LKey', 'return ( preg_match( ''/^[a-zA-Z0-9_-]+$/'', $arg0 ) and !file_exists( $dir[''root''] . $arg0 ) );', 1, '', 1, 0, 0, 17, 2, 17, 1, 17, 1, 17, 1, 0, NULL, 17, 3, 17, 2, 0, NULL, '', 17, 1, 17, 1, 0, NULL, 0, 0);
...
(4, 0, 'My Profile', '{memberNick}', '{memberLink}|{memberUsername}|change_status.php', 3, 'memb', '', '', 'return $GLOBALS[''profileID''] == $GLOBALS[''memberID''];', 1, 0, 0, 0, 1, 'system', 'user', '', 0, ''),
...
(9, 0, 'Profile View', '{profileNick}', '{profileUsername}|pedit.php?ID={profileID}', 0, 'non,memb', '', '', 'return $GLOBALS[''profileID''] != $GLOBALS[''memberID''];', 3, 1, 1, 0, 1, 'system', '', '', 0, ''),
